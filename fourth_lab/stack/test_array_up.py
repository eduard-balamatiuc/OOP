from array_up import ArrayStack
...
class TestArrayStack(unittest.TestCase):
    ...
    def test_push_resizing(self):
        stack = ArrayStack()
        for i in range(ArrayStack.INITIAL_SIZE):
            stack.push(i)
        # At this point, the stack should resize as we add the next element.
        stack.push(ArrayStack.INITIAL_SIZE)
        self.assertEqual(stack.peek(), ArrayStack.INITIAL_SIZE)
        self.assertEqual(stack.get_size(), ArrayStack.INITIAL_SIZE + 1)
